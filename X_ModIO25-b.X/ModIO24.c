...
// 06h: MrInit                     Dir-06h           (Dir+80)-06h-Dir-Ult
...
//            MioInterr();/////////////////////////////////////////////////////
        ...
        case 0x07: // Mr Agrega Reg    // (02,07, Reg(max 5 bytes)
            ...
            memcpy(&RsTxBuffer[2+MrLen], &RtcFechaHora[0], 6); // RtcFechaHora
            memcpy(&RsTxBuffer[8+MrLen], &MrDirV, 2);
            memcpy(&RsTxBuffer[10+MrLen], &MrUltV, 2);
...
//            break;
        ...
        case 0x11: // Agrega un dato ficticio al Mem Roller
//            DatFicAgregaReg();
            memcpy(&RsTxBuffer[2], &MrReg[0], MrLen); // copia registro
            memcpy(&RsTxBuffer[2+MrLen], &RtcFechaHora[0], 6); // RtcFechaHora
            memcpy(&RsTxBuffer[8+MrLen], &MrDirV, 2);
...
//        case 0x12:  //contesta con TempSeg      Para pruebas Rut Tiempo
...
//            break;
        ...
        case 0x22:  //Leer Entrada Analogica 0
            DisableInterrupts;
            memcpy (&(RsTxBuffer [2]),  &(MIOAdcAct[0]), 2);
